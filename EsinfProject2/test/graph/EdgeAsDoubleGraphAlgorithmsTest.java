...
public class EdgeAsDoubleGraphAlgorithmsTest {
    ...
    public void testMinDistGraph() {
        AdjacencyMatrixGraph<String, Double> mapmin = EdgeAsDoubleGraphAlgorithms.minDistGraph(distanceMap);
        double d = mapmin.getEdge("Porto", "Coimbra");
        assertEquals("Should be 115", d, 135.0, 0.0);
        double d2 = mapmin.getEdge("Coimbra", "Lisboa");
        assertEquals("Should be 115", d2, 200.0, 0.0);
        double d3 = mapmin.getEdge("Aveiro", "Leiria");
        assertEquals("Should be 115", d3, 120.0, 0.0);
    }
