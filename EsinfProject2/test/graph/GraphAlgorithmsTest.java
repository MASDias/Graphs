...
public class GraphAlgorithmsTest {
    ...
    public void testTransitiveClosure() {
        AdjacencyMatrixGraph<String, String> mapa = new AdjacencyMatrixGraph<>();
        mapa.insertVertex("A");
        mapa.insertVertex("B");
        mapa.insertVertex("C");
        mapa.insertVertex("D");
        ...
        mapa.insertEdge("A", "B", "1");
        mapa.insertEdge("B", "C", "2");
        mapa.insertEdge("C", "D", "3");
        mapa.insertEdge("D", "E", "4");
        mapa.insertEdge("D", "A", "5");
